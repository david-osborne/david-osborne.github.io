...
export class cShip {
  ...
  flameParticles: iParticle[] = [];

  initShip() {
    this.lastTimeStamp = Date.now();
  }

  drawShip(ctx: any, x: number, y: number) {
